...
<body onload="cacher()">
    ...
    <div class="container">
 <select onchange="changer();" id="selectchange"class="custom-select mb-3">
                    ...
                    <form action="conditions.html" method="post" name="login">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="numEleveur" class="form-control" id="numEleveur" aria-describedby="emailHelp" placeholder="Num Eleveur">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="" class="form-control" id="nomElevage" aria-describedby="emailHelp" placeholder="Nom de l'elevage">
                            </div>
                            <div class="form-group">

                                <input type="number" name="tailleElevage" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Taille de votre elevage">
                                
                            </div>
                               <div class="form-group">

                                <input type="text" name="Departement" class="form-control" id="departement" aria-describedby="emailHelp" placeholder="Departement">
